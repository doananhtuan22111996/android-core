...
class PagingLoadStateAdapter(private val retryFunc: (() -> Unit)? = null) : LoadStateAdapter<PagingLoadStateAdapter.PagingStateViewHolder>() {
    ...
    inner class PagingStateViewHolder(private val viewBinding: ItemPagingStateBinding) : RecyclerView.ViewHolder(viewBinding.root) {
        fun bind() {
